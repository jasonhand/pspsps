...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log("Optional filters toggle:", optionalFiltersToggle);
    console.log("Optional filters content:", optionalFiltersContent);
     
    if (optionalFiltersToggle && optionalFiltersContent) {
        console.log("Setting up optional filters toggle");
        ...
        optionalFiltersToggle.addEventListener("click", function(event) {
            console.log("Optional filters toggle clicked");
            ...
            if (isOpen) { 
                ...
                optionalFiltersContent.style.display = "none"; 
                console.log("Closing filters section");
            } else { 
                ...
                console.log("Opening filters section");
            }
        ...
        console.error("Optional filters elements not found!");
    }
    setupFormListeners();
